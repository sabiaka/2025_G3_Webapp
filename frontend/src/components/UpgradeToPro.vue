  ...
  >
    ...
    >
      <VCard>
        ...
        <VCardTitle>Materio - Vuetify管理テンプレート</VCardTitle>
        <VCardText>
          Materio Adminは、Vuetifyベースの開発者フレンドリーで高度にカスタマイズ可能な管理ダッシュボードテンプレートです。
        </VCardText>
        <VCardText>下のボタンをクリックしてPROバージョンを探索してください。</VCardText>
        <VCardText>
          <VBtn
            class="me-4"
